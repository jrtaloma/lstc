...
from net.model import DilatedRNN, LoSTer_DRNN, pretrain_ae, predict, pretrain_ae_augmented, predict_augmented
...
if __name__ == '__main__':
    ...
    # Autoencoders
    model = DilatedRNN(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type)
    model = model.to(device)
    model_augmented = DilatedRNN(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type)
    ...
    model = LoSTer_DRNN(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type, centroids=kmeans.cluster_centers_, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
    ...
    model_augmented = LoSTer_DRNN(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type, centroids=kmeans_augmented.cluster_centers_, path_pretrain=path_pretrain_augmented, device=device)
    model_augmented = model_augmented.to(device)
