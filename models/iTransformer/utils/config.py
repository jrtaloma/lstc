...
def get_arguments():
    ...
    parser.add_argument('--model_name', default='iTransformer', type=str, help='Name of the model')
    ...
    parser.add_argument('--use_norm', action='store_true', help='Use norm and denorm')
