...
if __name__ == '__main__':
    ...
    # Autoencoder
    model = DTCR(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type)
    ...
    # Training & testing
    epoch, preds, ri, ari, nmi, silhouette = train(args, model, train_loader, test_loader, criterion_rec, criterion_class, criterion_kmeans, optimizer, path_ckpt, device)
