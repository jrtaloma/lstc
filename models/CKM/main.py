...
from net.model import AE, CKM, pretrain_ae, predict
from utils.losses import KMeansLoss
...
if __name__ == '__main__':
    ...
    model = CKM(n_enc_1=500, n_enc_2=500, n_enc_3=1000, n_dec_1=1000, n_dec_2=500, n_dec_3=500, n_input=args.n_input, n_z=args.n_z, centroids=kmeans.cluster_centers_, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
