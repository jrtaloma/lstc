...
from net.model import AE, LoSTer, pretrain_ae, predict, pretrain_ae_augmented, predict_augmented
...
if __name__ == '__main__':
    ...
    model_augmented = AE(n_steps=args.n_input, n_steps_output=args.n_input, hidden_size=args.hidden_size, n_encoder_layers=args.n_encoder_layers, n_decoder_layers=args.n_decoder_layers, dropout=args.dropout, use_revin=args.use_revin, use_residual=False)
    ...
    model = LoSTer(n_steps=args.n_input, n_steps_output=args.n_input, hidden_size=args.hidden_size, n_encoder_layers=args.n_encoder_layers, n_decoder_layers=args.n_decoder_layers, dropout=args.dropout, use_revin=args.use_revin, use_residual=False, centroids=kmeans.cluster_centers_, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
    ...
    model_augmented = LoSTer(n_steps=args.n_input, n_steps_output=args.n_input, hidden_size=args.hidden_size, n_encoder_layers=args.n_encoder_layers, n_decoder_layers=args.n_decoder_layers, dropout=args.dropout, use_revin=args.use_revin, use_residual=False, centroids=kmeans_augmented.cluster_centers_, path_pretrain=path_pretrain_augmented, device=device)
    model_augmented = model_augmented.to(device)
