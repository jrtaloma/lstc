...
from net.model import AE, DEC, pretrain_ae, predict
...
if __name__ == '__main__':
    ...
    # Autoencoder
    model = AE(n_enc_1=500, n_enc_2=500, n_enc_3=1000, n_dec_1=1000, n_dec_2=500, n_dec_3=500, n_input=args.n_input, n_z=args.n_z)
    ...
    model = DEC(n_enc_1=500, n_enc_2=500, n_enc_3=1000, n_dec_1=1000, n_dec_2=500, n_dec_3=500, n_input=args.n_input, n_z=args.n_z, centroids=kmeans.cluster_centers_, alpha=args.alpha, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
    ...
    # Training & testing
    data = torch.tensor(train_dataset.time_series, device=device).data
    epoch, preds, probs, ri, ari, nmi, silhouette = train(args, model, data, train_loader, test_loader, optimizer, scheduler, path_ckpt, device)
