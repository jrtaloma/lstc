...
from net.model import AE, IDEC, pretrain_ae, predict
...
if __name__ == '__main__':
    ...
    model = IDEC(n_enc_1=500, n_enc_2=500, n_enc_3=1000, n_dec_1=1000, n_dec_2=500, n_dec_3=500, n_input=args.n_input, n_z=args.n_z, centroids=kmeans.cluster_centers_, alpha=args.alpha, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
