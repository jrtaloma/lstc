...
from net.model import DilatedRNN, DTC, pretrain_ae, predict
...
if __name__ == '__main__':
    ...
    model = DTC(input_size=args.input_size, hidden_sizes=args.hidden_sizes, dilations=args.dilations, n_steps=args.n_steps, cell_type=args.cell_type, centroids=kmeans.cluster_centers_, alpha=args.alpha, path_pretrain=path_pretrain, device=device)
    model = model.to(device)
